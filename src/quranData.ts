...
export const SURAH_INFO: Surah[] = [
  ...
  { number: 34, name: 'سبإ', englishName: 'Saba', numberOfAyahs: 54 },
  ...
  { number: 42, name: 'الشورى', englishName: 'Ash-Shuraa', numberOfAyahs: 53 },
  ...
  { number: 78, name: 'النبإ', englishName: 'An-Naba', numberOfAyahs: 40 },
...
export const BISMILLAH = 'بِسۡمِ ٱللَّهِ ٱلرَّحۡمَـٰنِ ٱلرَّحِیمِ';
